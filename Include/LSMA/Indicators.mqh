...
#property copyright   "Tony Tong"
#property link        "shidatonglin@gmail.com"
...
class CIndicator
{
	protected:
		...
		CIndicator(string pSymbol, int pTimeFrame);
...
void CIndicator::CIndicator(string pSymbol,int pTimeFrame)
{
   _symbol = pSymbol;
   _timeFrame = pTimeFrame;
   _digits = (int)MarketInfo(pSymbol,MODE_DIGITS);
...
void CiMA::CiMA(string pSymbol,int pTimeFrame,int pMaPeriod,int pMaShift,int pMaMethod
               ,int pAppliedPrice) : CIndicator(pSymbol, pTimeFrame)
{

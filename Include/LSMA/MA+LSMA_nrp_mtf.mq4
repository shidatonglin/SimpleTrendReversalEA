...
extern string note_MAmode_LSMA = "lsma4 SMA0 EMA1 SMMA2 LWMA3";
...
{ 
   ...
   if(counted_bars>0) counted_bars--;
      ...
      if (TimeFrame != Period())
      {
        ...
        for(i=limit; i>=0; i--)
         ...
         lsma[i]      = iCustom(NULL,TimeFrame,IndicatorFileName,MAPeriod,MAPrice,MAmode_LSMA,0,y);
   ...
   for(i = limit; i >= 0; i--)
   {
      ...
      if (MAmode_LSMA<0) MAmode_LSMA=0;
      if (MAmode_LSMA<4)

      lsma[i]   = iMA(NULL,0,MAPeriod,0,MAmode_LSMA,MAPrice,i);
